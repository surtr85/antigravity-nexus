...
export const forgetTool = {
    name: "memory_forget",
    description: "Delete or deprecate a memory. Defaults to deprecate (non-destructive): the note is kept with status=deprecated so history is preserved. Use mode=delete only for explicit destruction.",
