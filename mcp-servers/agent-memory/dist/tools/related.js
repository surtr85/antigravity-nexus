...
export const relatedTool = {
    name: "memory_related",
    description: "Explore the memory graph around a memory, following Obsidian wikilinks and indexed relationships (outbound links and inbound backlinks). Breadth-first traversal with a depth limit; it never traverses the whole vault.",
