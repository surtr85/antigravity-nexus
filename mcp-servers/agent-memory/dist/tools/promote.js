...
export const promoteTool = {
    name: "memory_promote",
    description: "Promote experiences/lessons/patterns into higher-level knowledge (experience → lesson → pattern → skill). Creates a new memory of the target type and preserves provenance via derived_from links to all source memories.",
