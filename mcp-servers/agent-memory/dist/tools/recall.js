...
export const recallTool = {
    name: "memory_recall",
    description: "Retrieve the most relevant memories for the current task. Ranked by textual relevance, title match, project, memory type, confidence, recency and graph links. Returns compact context for an LLM.",
