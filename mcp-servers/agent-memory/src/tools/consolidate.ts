...
export const consolidateTool: ToolDef = {
  name: "memory_consolidate",
  description:
    "Analyze memories and propose a consolidation plan: duplicates, merge candidates, contradictions, repeated experiences, pattern/skill candidates and stale notes. Read-only by default (dryRun=true). It never deletes data; applying only creates non-destructive candidate memories and links.",
