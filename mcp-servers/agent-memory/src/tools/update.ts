...
export const updateTool: ToolDef = {
  name: "memory_update",
  description:
    "Update a memory. Only the fields explicitly provided are changed; all other metadata is preserved. The current vault file is re-read before writing to avoid clobbering concurrent changes.",
