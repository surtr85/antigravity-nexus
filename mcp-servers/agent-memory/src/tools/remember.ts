...
export const rememberTool: ToolDef = {
  ...
  description:
    "Store a durable memory. Performs deduplication: if an equivalent memory already exists it is updated instead of duplicated; if a likely contradiction is found the write is rejected with action=conflict. Returns created|updated|unchanged|conflict.",
